(function () {
    ...
    // The caller (renderCurrentView) is responsible for guarding against a missing bill.
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4 no-print">
                    ...
                    <div class="flex flex-wrap gap-2 md:gap-3">
                        <button
                            ...
                            class="px-4 md:px-6 py-2 md:py-3 bg-gray-300 rounded-lg font-semibold text-sm md:text-base">
                            رجوع
                        </button>
                        <button
                            data-action="edit-bill"
                            class="px-4 md:px-6 py-2 md:py-3 rounded-lg font-semibold text-white flex items-center gap-2 text-sm md:text-base"
                            style="background-color: ${config.accent_color};">
                            ✏️ تعديل
                        </button>
                        <button
                        ...
                        <button
                            ...
                            class="px-4 md:px-6 py-2 md:py-3 bg-blue-500 rounded-lg font-semibold text-white flex items-center gap-2 text-sm md:text-base disabled:opacity-60 disabled:cursor-not-allowed">
                        ...
                        <button
                            ...
                            class="px-4 md:px-6 py-2 md:py-3 bg-green-600 rounded-lg font-semibold text-white flex items-center gap-2 text-sm md:text-base disabled:opacity-60 disabled:cursor-not-allowed">
                            ...
                            <div class="print-header-grid">
                                <div class="print-company text-right">
                                    <div class="flex items-center gap-3 mb-2">
                                        <div class="h-12 md:h-16 flex items-center justify-center shrink-0 p-1 bg-white rounded-lg"
                                             style="border: 2px solid ${config.primary_color};">
                                            <img src="${logoSrc}" alt="شعار الشركة" class="h-full w-auto object-contain" />
                                        </div>
                                        <div>
                                    ...
                                    <div class="mt-4 pt-3 border-t border-dashed"
                                         style="border-color: ${config.primary_color};">
                                ...
                                <div class="print-invoice text-left">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-base md:text-lg font-semibold">
                                            ${new Date(bill.billDate).toLocaleDateString('ar-SA', {
                                                year: 'numeric',
                                                month: 'long',
                                                day: 'numeric'
                                            })}
    ...
    window.billTemplateRegistry.fallback = { renderViewBill };
})();
